...
const DEFAULT_OG_IMAGE =
    'https://res.cloudinary.com/dpflidsbg/image/upload/v1734327549/arcmen/qmzzdyddtrshcqtlostn.webp';
...
const projects = {
    ...
    'interior-design-valasaravakkam-architectural': {
        ...
        description:
            "Discover Arcmen's interior design project in Valasaravakkam with customized layouts, contemporary interiors, and stylish living spaces.",
        image: DEFAULT_OG_IMAGE,
    },
    ...
    'living-room-double-height-interior-design-architectural': {
        ...
        description:
            "View Arcmen's double-height living room design showcasing spacious interiors, premium finishes, modern aesthetics, and elegant architectural details.",
        image: DEFAULT_OG_IMAGE,
    },
    ...
    'pool-terrace-design-architectural': {
        ...
        description:
            "Explore Arcmen's pool terrace design project featuring luxurious outdoor spaces, stylish landscaping, finest functional layouts & modern architecture.",
        image: 'https://res.cloudinary.com/dpflidsbg/image/upload/v1735640126/arcmen/Architectural%20Design%20Projects/Rajendera/rajendra-kumar-02.jpg',
    },

    'bedroom-interior-design-architectural': {
        title: 'Bedroom Interior Design Project | Arcmen Chennai',
        description:
            "View Arcmen's bedroom interior design project featuring elegant decor, customised furniture, smart storage solutions and contemporary design elements.",
        image: 'https://res.cloudinary.com/dpflidsbg/image/upload/v1735640574/arcmen/Architectural%20Design%20Projects/jean-interior/jean-interior-02.jpg',
    },

    'duplex-house-elevation-design-nolambur-architectural': {
        title: 'Duplex House Elevation Design in Nolambur | Arcmen',
        description:
            "Discover Arcmen's duplex house elevation design in Nolambur featuring premium architecture, modern exteriors, and elegant façade concepts.",
        image: DEFAULT_OG_IMAGE,
    },
    ...
    'duplex-villa-elevation-design-architectural': {
        ...
        image: 'https://res.cloudinary.com/dpflidsbg/image/upload/v1735641343/arcmen/Architectural%20Design%20Projects/Mahaveer/Mahaveer-1.jpg',
    },

    'house-of-glass-front-elevation-design-architectural': {
        title: 'Glass Front House Elevation Design Project | Arcmen',
        description:
            "Discover Arcmen's stunning glass front house elevation design featuring contemporary architecture, elegant glass facades, and modern exterior styling.",
        image:
    ...
    'villa-landscape-design-architectural': {
        ...
        description:
            "Explore Arcmen's villa landscape design featuring thoughtfully planned outdoor spaces, lush greenery, hardscaping and elegant residential landscaping.",
        image: 'https://res.cloudinary.com/dpflidsbg/image/upload/v1735641741/arcmen/Architectural%20Design%20Projects/Balu/Balu-02.jpg',
    },

    'row-house-architectural': {
        title: 'Row House Architectural Design Project | Arcmen Chennai',
        description:
            "View Arcmen's premier row house architectural project featuring smart space planning, contemporary elevations, and modern residential design concepts.",
        image:
            'https://res.cloudinary.com/dpflidsbg/image/upload/v1735642034/arcmen/Architectural%20Design%20Projects/Row%20House/Row%20House-01.jpg',
    },

    'villa-elevation-design-sadik-architectural': {
        title: 'Villa Elevation Design Project – Sadik Residence | Arcmen',
        description:
            "Discover Arcmen's villa elevation design for the Sadik residence, showcasing stunning architecture, luxurious facades, and stylish exterior detailing.",
        image: DEFAULT_OG_IMAGE,
    },
    ...
    'duplex-house-elevation-design-front-ayyampettai-architectural': {
        ...
        description:
            "Explore Arcmen's front duplex house elevation project in Ayyampettai featuring stylish facades, modern architecture, and premium exterior designs.",
        image: DEFAULT_OG_IMAGE,
    },
};
...
export async function generateMetadata({ params }) {
    ...
    const title =
        project?.title || 'Architectural Design Projects | Arcmen Chennai';

    const description =
        project?.description ||
        'Explore architectural and interior design projects by Arcmen Interior in Chennai and across Tamil Nadu.';
        ...
        breadcrumb: {
            ...
            itemListElement: [
...

                {
                    ...
                    item: `${SITE_URL}/architectural-projects`,
                },
