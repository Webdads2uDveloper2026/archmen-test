                    ...
                    <Row>
                        ...
                        <Col lg={4} md={6} xs={12}>
                            <div className="project-card">
                                ...
                                <div className="overlay">
                                    {' '}
                                    <Link href="interior-design-projects/mrs-mohan/">Mrs Mohan & Family</Link>
                                </div>
                            </div>
                        </Col>
                        <Col lg={4} md={6} xs={12}>
                        ...
                        <Col lg={4} md={6} xs={12}>
                            <div className="project-card">
                                ...
                                ></img>
                                <div className="overlay">
                                    <Link href="interior-design-projects/mr-kandhan-family/">Mr. Kandhan Family</Link>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col lg={4} md={6} xs={12}>
                            <div className="project-card">
                                ...
                                ></img>
                                <div className="overlay">
                                    <Link href="interior-design-projects/nbs-vijay-shankar-family">NBS Vijay Shankar & Family</Link>
                                </div>
                            </div>
                        </Col>
                    </Row>
