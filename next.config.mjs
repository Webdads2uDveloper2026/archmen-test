...
const nextConfig = {
    ...
    async redirects() {
        ...
        { source: '/3bhk-apartment-adayar-interior', destination: '/interior-design-projects/mrs-nithya-srinivasan', permanent: true },
        ...
        { source: '/3bhk-apartment-velacherry-interior', destination: '/interior-design-projects/mr-rama-elangovan', permanent: true },
        { source: '/individual-house-kknagar-interior', destination: '/interior-design-projects/mr-srinath-kanya', permanent: true },
        { source: '/individual-duplex-house-annanagar-interior', destination: '/interior-design-projects/mr-arun-dev', permanent: true },
        { source: '/individual-house-perambur-interior', destination: '/interior-design-projects/mrs-porchelvi', permanent: true },
        ...
        { source: '/duplex-house-elevation-design-peravurani-architectural', destination: '/architectural-projects/duplex-house-elevation-design-peravurani-architectural', permanent: true },
        ...
        { source: '/architectural-projects/individual-house-kknagar-interior', destination: '/interior-design-projects/mr-srinath-kanya', permanent: true }
        ];
    },
